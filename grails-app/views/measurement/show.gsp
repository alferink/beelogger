...
<html>
    ...
    <body>
        ...
        <div id="show-measurement" class="content scaffold-show" role="main">
            ...
            <f:display bean="measurement" />
            <g:form resource="${this.measurement}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.measurement}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
